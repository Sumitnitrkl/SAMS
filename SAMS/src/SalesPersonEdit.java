...
public class SalesPersonEdit extends JFrame {
...
//			long mobileNumber;
			...
			String sql = "SELECT name,username,password,email,address,age,mobilenumber,gender FROM salesperson WHERE `id`='"+ id +"'";
...
//					String sql = "INSERT INTO salesperson(name,gender,age,mobilenumber,email,address,username,password) " +
//				                   "VALUES ('"+name+"','"+gender+"','"+age+"','"+mobileNumber+"','"+email+"','"+address+"','"+username+"','"+password+"') " ;
					String sql = "INSERT INTO salesperson(id,name,gender,age,mobilenumber,email,address,username,password) " +
				    ...
				    SalesPersonHome home = new SalesPersonHome(id);
